!jzhan166 9/30/2022 added new XNOX
module mo_gas_phase_chemdr
  ...
  integer :: so4_ndx, h2o_ndx, o2_ndx, o_ndx, hno3_ndx, xhno3_ndx, hcl_ndx, cldice_ndx, snow_ndx
...
!
    ...
    real(r8) :: xhno3_cond(ncol,pver,2)        ! xhno3 condensed phase concentration (mol/mo
